...
%          Enter [] for default.
%
%    S0 = the smallest scale of the wavelet.   Default is 2*DT. Enter [] for default.
%
...
% 
% ------------------------
% Last modified: Jon Erickson, Oct 14, 2014. 
%    -changed default J1 to be the ceiling instead of fix(...)
%    -changed default input args handling
% 
% Original code by:
%----------------------------------------------------------------------------
...
%----------------------------------------------------------------------------
function [wave] = contwt(Y,dt,pad,dj,s0,J1,mother,param);
