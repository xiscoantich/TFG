classdef WaveletTransformer < handle
    ...
    methods (Access = private)
        ...
        function wvf = load_wavelet(obj,wavelet,normw)
            %Example:
            ...
            %compute P0(z)
            [P0z,P0zdelay] = obj.signal_mult(H0z,H0delay,H1nz,H1delay);
            [P0nz,P0nzdelay] = obj.signal_mult(H0nz,H0delay,H1z,H1delay);
            [PR,PRdelay] = obj.signal_add(P0z,P0zdelay,-1*P0nz,P0nzdelay);
            
            %INSTRUCTION: change PR_tolerance depending on how precise the coefficients have to be
            PR_tolerance = 10^(-5);
            PR(abs(PR) < PR_tolerance) = 0;
            [PR,PRdelay] = obj.signal_add(PR,PRdelay,0,0); %to get rid of extra zeroes
            ...
            if nargin == 2
                ...
                elseif strcmpi(normw,'EU') %gains are equal to 1
